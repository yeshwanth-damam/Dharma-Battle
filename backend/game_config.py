"""Shared game configuration (single source of truth).

Imported by both the REST API (``server.py``) and the authoritative
real-time co-op server (``realtime.py``) so the two never drift apart.
"""
